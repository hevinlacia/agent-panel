...
export function ProjectsPage({ globalProject }: { globalProject: string }) {
  ...
  const filtered = useMemo(() => requirementOnly.filter((r) => {
    ...
    return true
  }).sort((a, b) => b.updatedAt - a.updatedAt), [requirementOnly, statuses, defaultExcludedStatuses, project, createdFrom, createdTo, keyword, billableOnly, noOnesOnly, win])
