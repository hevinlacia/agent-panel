...
## 必读
- memory.md、impact.md、branch.md、config-changes.md、release-manifest.md
- ~/.agents/knowledge/wms/conventions-wms-backend-logging.md

## 必做
- 每次代码改动完成后立即提交并同步到需求分支（自测中、测试中、经验总结等后续状态同样适用）
- 先按 impact.md 校验核心链路风险
- 实现最小正确改动并同步维护 branch.md/config-changes.md/release-manifest.md/notes.md
